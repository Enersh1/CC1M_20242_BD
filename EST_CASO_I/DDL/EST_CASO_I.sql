...
SHOW TABLES;
#modificando o atributo da tabela filiais (alter)
ALTER TABLE filiais MODIFY FILIAL_RUA varchar(110) not null;
#modificando atributo da tabela fornecedores (alter)
ALTER TABLE fornecedores MODIFY FORNEC_RUA varchar(100) not null;
#adicionando atributo na tabela filiais (alter)
ALTER TABLE filiais add FILIAL_agiota varchar(50) not null;
#removendo atributo da tabela filiais (drop)
ALTER TABLE filiais drop FILIAL_agiota;